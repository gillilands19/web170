...
#EDIT THE FOLLOWING:
$toAddress = "gillilands19@gmail.com";  //place your/your client's email address here
$toName = "Sean Gilliland"; //place your client's name here
$website = "RPR Builders";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        ...
        <p id="confirm-close" style="cursor: pointer; font-size=1.25em;" onclick="location.href='./index.php'"> CLOSE [X]</p>
        </div>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
...
?>
	...
	<div>
		<label>
            <input type="text" name="Name" required="required" placeholder="Full Name (required)" title="Name is required" tabindex="10" size="44" />
		</label>
	</div>
	<div>	
		<label>
            <input type="email" name="Email" required="required" placeholder="Your Email (required)" title="A valid email is required" tabindex="20" size="44" />
        </label>
	</div>
